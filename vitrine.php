...
// echo "get";;;
$conteudo = $db->query("select * from conteudos where type = 2 order by id desc ")->results();
// dump( $conteudo );
        ...
        <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item-second" style=" background-color: #ececec; border-radius:20px 20px 0 0">
                <a class="nav-link" href="vitrine.php" id="menu-blog">
                    <p class="mbr-fonts-style display-6" style="color: #04112b;"> Vitrine de Mercado</p>
                </a>
            </li>
            <li class="nav-item-second">
