        ...
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">PIX será ‘tão seguro quanto’ outros sistemas de pagamento, diz diretor do BC</h4>
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">Peac-Maquininhas: Está liberada a primeira parcela de R$ 5 bilhões para os pequenos empresários</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">Publicado o Decreto 864/2020 em Santa Catarina que faculta ao contribuinte a possibilidade de emissão de NFC-e.</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">Como os bancos estão se preparando para oferecer o PIX aos seus clientes?</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
        ...
        <div class="media-container-row">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box">
                        <h4 class="card-title mbr-fonts-style display-7">Bolsonaro sanciona lei que muda regras de cobrança de ISS</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">O que se sabe até agora sobre o WhatsApp Pagamentos?</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">Banco Central Divulga a API Pix</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
            ...
            <div class="card p-3 col-12 col-md-4">
                <div class="card-wrapper">
                    ...
                    <div class="card-box ">
                        <h4 class="card-title mbr-fonts-style display-7">Confira o 1º episódio do podcast “Ícones da Automação” produzido pela AFRAC.</h4>
                        <p class="mbr-text mbr-fonts-style display-7">
